...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firstChoice.setTag("0"); secondChoice.setTag("0"); thirdChoice.setTag("0");
        ...
        thirdChoice.setOnClickListener(view -> thirdChoice.setTag("1"));
        ...
        if (firstChoice.getTag().equals("13")) {
